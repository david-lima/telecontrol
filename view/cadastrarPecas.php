            ...
            <form action="" method="POST">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="Sobrenome">Nota Fiscal</label>
                  <input type="text" class="form-control" id="nf" name="nf" placeholder="Nº da NF">
                </div>
                ...
                <div class="form-group col-md-3">
                  <label for="Sobrenome">Tensao</label>
                  <input type="text" class="form-control" id="tensao" name="tensao" placeholder="Tensao">
                </div>
                <div class="form-group col-md-12">
                  <label for="Nome">Descrição</label>
                  <input type="text" class="form-control" id="desc" name="desc" placeholder="Descrição">
                </div>
