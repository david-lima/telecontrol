<?php 
  ...
  $objCliente = new Cliente();
    ...
    if(isset($_POST["Enviar"]) && $_POST["Enviar"] == "Cadastrar"){
      $cliente = $objCliente->cadastrarCliente($_POST["nome"],$_POST['sobrenome'],$_POST['nomesocial'],$_POST['endereco'],$_POST['bairro'],$_POST['numero'],$_POST['referencia'],$_POST['estado'],$_POST['cep'],$_POST['email'],$_POST['cnpj'],$_POST['telefone'],$_POST['celular'],$_POST['layout'],$_POST['descricao'],$_POST['valor'],$_POST['cidade'],$_POST['cpf']);
    }
?>
<!DOCTYPE html>
<html lang="en">
   ...
   <a class="dropdown-item" href="cadastrarRequisicao.php">Cadastrar Requisição</a>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          <?php echo (isset($cliente)?$cliente:'')?>
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
