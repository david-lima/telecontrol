<?php
require_once('../class/MaoDeObra.php');

$objMDO = new MaoDeObra();
if (isset($_POST["Enviar"]) && $_POST["Enviar"] == "Cadastrar") {
  $msg = $objMDO->CadastrarMDO();
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mx-auto">
          <div class="card-header">Cadastro de Mão de Obra</div>
          <div class="card-body">
            <form action="" method="POST">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="nome" name="desc" placeholder="Descrição">
                </div>
                <div class="form-group col-md-6">
