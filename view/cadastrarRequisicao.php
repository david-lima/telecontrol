...
if (isset($_POST["Enviar"]) && $_POST["Enviar"] == "Cadastrar") {
  $resposta = $objRequisicao->cadastrarRequisicao($_POST['cliente'], $_POST['responsavel'], $_POST['urgencia'], $_POST['situacao'], $_POST['data'], $_POST['descricao']);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="content-wrapper">
      ...
      if (isset($resposta)) {
        ...
        <div class="card mx-auto">
          <div class="card-header">Cadastro de Requisições</div>
          <div class="card-body">
            <form action="" method="POST">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select id="cliente" name="cliente" class="form-control">
                    ...
                    <?php foreach ($clientes as  $row) {
                      if (!empty($row['id'])) {
                    ?>
                        <option value="<?= $row['id']; ?>"><?= $row['nome_social']; ?></option>
                ...
                <div class="form-group col-md-2">
                  ...
                  <input type="text" class="form-control" id="data" placeholder="Data Prazo" name="data">
                </div>
                <div class="form-group col-md-12">
                  <label for="descricao">Descrição</label>
                  <textarea style="min-height: 150px;" type="text" class="form-control" id="descricao" placeholder="Descrição" name="descricao"></textarea>
                </div>
              </div>
